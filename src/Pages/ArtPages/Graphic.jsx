...
import imgillu from "../../Assets/Design/DesingHeader/Graphic.png";
  ...
  return (
    <div className="div-container-body-iustration">
      ...
      >
        ...
        <SwiperSlide>
          <img src={PrintingOne} alt="slide_image" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={PrintingTwo} alt="slide_image" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={PrintingFour} alt="slide_image" />
        </SwiperSlide>
